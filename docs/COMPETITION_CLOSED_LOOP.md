...
```text
VERIFICATION_CANDIDATE = 05c4b4aa1a02ced03af377a75b07443da6602d8a
```
...
`5f4d8592`, naming this candidate.
...
- [x] One candidate SHA holds across every surface. Verification installs and
  ...
  The current candidate is `05c4b4aa1a02ced03af377a75b07443da6602d8a`,
